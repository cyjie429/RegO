...
from avalanche.training.strategies import Naive, CWRStar, Replay, GDumb, Cumulative, GEM, AGEM, EWC,JointTraining,SynapticIntelligence,CoPE, OWM, RAWM, RWM, RegO
